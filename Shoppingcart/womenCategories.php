...
<head>
    ...
    <title>Women shoes categories</title>
</head>
                ...
                <div class="row mx-auto my-auto">
                    <div id="recipeCarousel" class="carousel slide w-100" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            ...
                            WHERE pcc.PROD_CATALOG_ID='ShoesCatalog' AND pc.PRODUCT_CATEGORY_ID LIKE 'W_SH_%'
                    ";
                                    ...
                                    for ($i = 0; $i < $totalSlides; $i++) {
                                        ...
                                        for ($j = 0; $j < $itemsPerSlide; $j++) {
                                            ...
                                            if ($row) {
                                                ...
                                                if ($row['CATEGORY_NAME'] === 'Women formal shoes') {

                                                    echo '<a class="btn btn-dark" href="womenFormalShoes.php">' . $row['CATEGORY_NAME'] . '</a>';
                                                } else {
                                                    echo '<a class="btn btn-dark" href="womenSportsShoes.php">' . $row['CATEGORY_NAME'] . '</a>';
                                                }
                                                echo '</div>';
                                                echo '</div>';
