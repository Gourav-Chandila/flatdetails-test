...
GROUP BY p.PARTY_ID, pc.FIRST_NAME, pc.LAST_NAME, dr.data_resource_id, c.content_id, pcn.PARTY_CONTENT_TYPE_ID";
                ...
                <div>
                    ...
                    <div class="col my-4">
                        <input type="text" id="" class="form-control" placeholder="Secondary phone number"
                            value="<?php echo $secPhoneNumber; ?>">
                    </div>
                    <div class="col my-4">
                        <input type="text" id="" class="form-control" placeholder="Email address"
                ...
                <div class="col-auto">
                    ...
                    <div class="row col">
                        <input type="text" id="" class="form-control" placeholder="Coapplicant name"
                            value="<?php echo $coapplicantName; ?>">
                    </div>
